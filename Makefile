...
em-out/flif.html: maniac/*.h maniac/*.cpp image/*.h image/*.cpp transform/*.h transform/*.cpp flif-em.cpp flif-enc.cpp flif-dec.cpp common.cpp flif.h flif-enc.h flif-dec.h common.h flif_config.h fileio.h bufferio.h
	${CXX} -std=gnu++11 $(CXXFLAGS) $(LDFLAGS) -DNDEBUG -O3 -g0 -Wall maniac/util.cpp maniac/chance.cpp image/crc32k.cpp image/color_range.cpp transform/factory.cpp flif-em.cpp common.cpp flif-dec.cpp -o em-out/flif.html
